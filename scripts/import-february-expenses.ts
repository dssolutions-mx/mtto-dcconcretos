/**
 * Import February 2026 Expenses from CSV
 *
 * This script reads GASTOS_FEBRERO2026_CLASIFICADOS.csv and imports all expenses
 * as manual financial adjustments for February 2026.
 *
 * Usage:
 *   npx tsx scripts/import-february-expenses.ts
 */
...
async function main() {
  console.log('🚀 Starting February 2026 Expense Import...\n')

  const csvPath = path.join(process.cwd(), 'GASTOS_FEBRERO2026_CLASIFICADOS.csv')
  ...
  console.log(`   Found ${volumesByCode.size} plant volumes (Feb 2026)`)
