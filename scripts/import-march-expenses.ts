/**
 * Import March 2026 Expenses from CSV
 *
 * This script reads GASTOS_MARZO2026_CLASIFICADOS.csv and imports all expenses
 * as manual financial adjustments for March 2026.
 *
 * Usage:
...
async function main() {
  console.log('🚀 Starting March 2026 Expense Import...\n')

  const csvPath = path.join(process.cwd(), 'GASTOS_MARZO2026_CLASIFICADOS.csv')
  ...
  console.log(`   Found ${volumesByCode.size} plant volumes (${PERIOD_MONTH})`)
