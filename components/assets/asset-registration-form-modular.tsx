...
const formSchema = z.object({
  ...
  initialKilometers: z.string().optional().refine((val) => !val || !isNaN(Number(val)), { message: "Debe ser un número válido" }),
  currentKilometers: z.string().optional().refine((val) => !val || !isNaN(Number(val)), { message: "Debe ser un número válido" }),
