...
const operatorSchema = z.object({
  ...
  role: z.enum(['OPERADOR', 'DOSIFICADOR', 'JEFE_PLANTA', 'JEFE_UNIDAD_NEGOCIO', 'AUXILIAR_COMPRAS', 'AREA_ADMINISTRATIVA', 'VISUALIZADOR', 'COORDINADOR_MANTENIMIENTO', 'GERENTE_MANTENIMIENTO', 'MECANICO', 'RECURSOS_HUMANOS', 'ENCARGADO_ALMACEN']),
