...
const operatorSchema = z.object({
  ...
  role: z.enum(['OPERADOR', 'DOSIFICADOR', 'JEFE_PLANTA', 'ENCARGADO_MANTENIMIENTO', 'JEFE_UNIDAD_NEGOCIO', 'AUXILIAR_COMPRAS', 'AREA_ADMINISTRATIVA', 'VISUALIZADOR', 'COORDINADOR_MANTENIMIENTO', 'GERENTE_MANTENIMIENTO', 'MECANICO', 'RECURSOS_HUMANOS', 'ENCARGADO_ALMACEN']),
...
const roleOptions = [
  ...
  { value: 'ENCARGADO_MANTENIMIENTO', label: 'Coordinador Mant. (Legacy)', defaultAuth: 1000 },
  { value: 'COORDINADOR_MANTENIMIENTO', label: 'Coordinador de Mantenimiento', defaultAuth: 1000 },
  { value: 'GERENTE_MANTENIMIENTO', label: 'Gerente de Mantenimiento', defaultAuth: 0 },
  { value: 'MECANICO', label: 'Mecánico', defaultAuth: 0 },
  { value: 'RECURSOS_HUMANOS', label: 'Recursos Humanos', defaultAuth: 0 },
