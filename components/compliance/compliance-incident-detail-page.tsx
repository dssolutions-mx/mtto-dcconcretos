...
export function ComplianceIncidentDetailPage({
  ...
  const canReview = () => {
    if (!incident || !profile) return false
    const allowedRoles = ['GERENCIA_GENERAL', 'JEFE_UNIDAD_NEGOCIO', 'JEFE_PLANTA', 'AREA_ADMINISTRATIVA', 'GERENTE_MANTENIMIENTO', 'COORDINADOR_MANTENIMIENTO', 'RECURSOS_HUMANOS']
    return (
