...
import { Search, Printer, Download, Eye, Edit, Users, FileText, UserPlus, X, Building2 } from 'lucide-react'
...
import { EmployeeCredentialEditForm } from './employee-credential-edit-form'
import {
  Dialog,
  DialogContent,
  DialogHeader,
  ...
  const fetchEmployees = async () => {
    try {
      ...
      const mappedData = (data || []).map((emp: Record<string, unknown>) => {
        const mapped: Record<string, unknown> = { ...emp }
