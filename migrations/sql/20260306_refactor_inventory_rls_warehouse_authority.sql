...
BEGIN
  ...
  IF p_permission = 'release' THEN
    v_can_do := v_role IN ('GERENCIA_GENERAL','AREA_ADMINISTRATIVA','AUXILIAR_COMPRAS','ENCARGADO_ALMACEN','JEFE_UNIDAD_NEGOCIO','JEFE_PLANTA','ENCARGADO_MANTENIMIENTO','GERENTE_MANTENIMIENTO');
  ELSIF p_permission = 'receive' THEN
    v_can_do := v_role IN ('GERENCIA_GENERAL','AREA_ADMINISTRATIVA','AUXILIAR_COMPRAS','ENCARGADO_ALMACEN','JEFE_UNIDAD_NEGOCIO','JEFE_PLANTA','ENCARGADO_MANTENIMIENTO','DOSIFICADOR','GERENTE_MANTENIMIENTO');
  ELSIF p_permission = 'adjust' THEN
