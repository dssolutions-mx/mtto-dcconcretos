...
Ausencia nunca justifica omisión del proceso.
...
## Alta de Usuarios y Asignación Operador–Equipo
...
**OC preventivas NO requieren GG.**

---

## Correctivo — Protocolo PAT

**Orígenes:** Checklist, reporte directo, inspección, alerta de sistema.

Si la incidencia no la registra el operador y tiene que intervenir el Coordinador = omisión en la línea de reporte → conciliación.
...
OC en activo = vinculada a OT. OC reabastecimiento de inventario = sin OT.
...
| Omisión | Responsable | Sanción |
|---------|-------------|---------|
| No registrar carga | Dosificador | 30% del costo |
| No registrar carga | JP | 35% del costo |
| No registrar carga | JUN | 35% del costo |

Sin JP: JUN absorbe (35%+35% = 70%). Sin JUN: Gerente de Mtto reporta directo a GG.
...
| Omisión | Responsable | Sanción |
|---------|-------------|---------|
| No completar | Dosificador/Operador | Retención del día + incidencia |
| No reportar falla | Dosificador/Operador | 50% costo de reparación |
| Permitir operar sin checklist | JP (o JUN) | Descuento bono |
...
| Omisión | Sanción |
|---------|---------|
| 1 semana | Descuento bono |
| 2 semanas | Acta + 30% bono |
| 4 semanas | Proceso disciplinario + revisión gerencial |

---

## Servicios Externos y Padrón de Proveedores
...
| Omisión | Sanción |
|---------|---------|
| Fuera de padrón sin autorización | 30% bono + investigación |
| Servicio sin supervisión | Hasta 50% costo de reparación |
...
### Conciliación (RRHH)
Proceso flexible — entender qué pasó, no solo sancionar.
...
Discrepancias checklist vs. incidencias se revisan en conciliación.

**Semana 1 tras firma:** tolerancia por causas técnicas. Después, sin excepción.
...
## KPIs Mensuales (Gerente de Mtto)
